...
export const themes = {
  'claude-code': {
    ...
    accent: { primary: '#D97757', light: '#E2A48B', lighter: '#FFB38A', dark: '#C15F3C', userBubble: '#D97757' },
  ...
  'claude-chat': {
    ...
    accent: { primary: '#D97757', light: '#E8A088', lighter: '#F0C4B0', dark: '#C15F3C', userBubble: '#141413' },
  ...
  'gpt': {
    ...
    accent: { primary: '#10A37F', light: '#1DC990', lighter: '#6DE4B8', dark: '#0D8A6A', userBubble: '#10A37F' },
  ...
  'midnight': {
    ...
    accent: { primary: '#3B82F6', light: '#60A5FA', lighter: '#93C5FD', dark: '#2563EB', userBubble: '#3B82F6' },
