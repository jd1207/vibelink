...
```bash
node scripts/show-qr.js 100.85.13.101 3400 testtoken123
```

Expected: QR code rendered in terminal encoding `vibelink://connect?host=100.85.13.101&port=3400&token=testtoken123`
